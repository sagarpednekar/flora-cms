...
const speciesService = __importStar(require("./species.service.js"));
const importService = __importStar(require("./species.import.service.js"));
async function list(req, res) {
    const result = await speciesService.list(req.query);
    res.json(result);
}
